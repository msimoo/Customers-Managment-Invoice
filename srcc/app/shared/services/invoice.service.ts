...
export class InvoiceService {
    ...
    getByCustomerId(id: string): Observable<Invoice[]> {
        return this.http.get<Invoice[]>(this.apiUrl + 'getByCustomerId?customer=' + id)
            .pipe(catchError(error => throwError(error)));
    }
    ...
    deleteByCustomer(id: number): Observable<boolean> {
        return this.http.delete<boolean>(this.apiUrl + 'deleteByCustomerId?customer=' + id)
            .pipe(catchError(error => throwError(error)));
    }
}
