...
namespace CustomersManagementApp.Components.DataContext {
	public partial class InvoiceContext : DbContext
    {
        ...
        public virtual DbSet<CustomerHasAddress> CustomerHasAddresses { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerHasAddress>(entity =>
            {
                entity.HasKey(e => new { e.CustomerId, e.PostalCode, e.Number });

                entity.ToTable("customer_has_addresses");
                ...
                entity.HasOne(e => e.Customer)
                    ...
                    .HasConstraintName("dha_customer_fk")
            ...
            modelBuilder.Entity<Invoice>(entity =>
            {
                ...
                entity.HasOne(e => e.Customer)
                    ...
                    .HasForeignKey(e => e.CustomerId)
                    .HasConstraintName("invoices_customers_fk");
